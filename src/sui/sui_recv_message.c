...
static void nick_event_box_on_button_press(GtkWidget *widget,
        GdkEventButton *event, gpointer user_data);
static void nick_event_box_on_button_release(GtkWidget *widget,
        GdkEventButton *event, gpointer user_data);
...
static void sui_recv_message_init(SuiRecvMessage *self){
    ...
    g_signal_connect(self->nick_event_box, "button-press-event",
            G_CALLBACK(nick_event_box_on_button_press), self);
    g_signal_connect(self->nick_event_box, "button-release-event",
            G_CALLBACK(nick_event_box_on_button_release), self);
...
static void sui_recv_message_class_init(SuiRecvMessageClass *class){
    ...
    gtk_widget_class_bind_template_child(widget_class, SuiRecvMessage, nick_event_box);
    gtk_widget_class_bind_template_child(widget_class, SuiRecvMessage, nick_label);
    gtk_widget_class_bind_template_child(widget_class, SuiRecvMessage, identify_label);
...
static void sui_recv_message_update(SuiMessage *msg){
    ...
    gtk_label_set_markup(self->nick_label, ctx->dname);
...
static void nick_event_box_on_button_press(GtkWidget *widget,
    ...
    nick_menu_popup(widget, event, gtk_label_get_text(self->nick_label));
}
...
static void nick_event_box_on_button_release(GtkWidget *widget,
    ...
    self = SUI_RECV_MESSAGE(user_data);
    insert_text = g_strdup_printf("%s: ", gtk_label_get_text(self->nick_label));
