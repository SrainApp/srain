...
void srv_test_ui_user_list_rm(const char *server_name, const char *chan_name, const char *nick, const char *reason);
void srv_test_ui_user_list_rename(const char *server_name, const char *chan_name, const char *old_nick, const char *new_nick, UserType type);
