...
int ui_user_list_add(const char *server_name, const char *chan_name, const char *nick, IRCUserType type);
int ui_user_list_rm(const char *server_name, const char *chan_name, const char *nick, const char *reason);
int ui_user_list_rename(const char *server_name, const char *chan_name, const char *old_nick, const char *new_nick);
