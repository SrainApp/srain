...
void ui_chan_user_list_add(const char *chan_name, const char *name, IRCUserType type, int if_sys_msg);
void ui_chan_user_list_rm(const char *chan_name, const char *name, const char *reason);
