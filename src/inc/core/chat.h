...
void srn_chat_add_sent_message(SrnChat *chat, const char *content, SircMessageContext *context);
void srn_chat_add_recv_message(SrnChat *chat, SrnChatUser *user, const char *content, SircMessageContext *context);
void srn_chat_add_action_message(SrnChat *chat, SrnChatUser *user, const char *content, SircMessageContext *context);
void srn_chat_add_notice_message(SrnChat *chat, SrnChatUser *user, const char *content, SircMessageContext *context);
void srn_chat_add_misc_message(SrnChat *self, const char *content, SircMessageContext *context);
void srn_chat_add_misc_message_fmt(SrnChat *self, SircMessageContext *context, const char *fmt, ...);
void srn_chat_add_misc_message_with_user(SrnChat *chat, SrnChatUser *user, const char *content, SircMessageContext *context);
void srn_chat_add_misc_message_with_user_fmt(SrnChat *chat, SrnChatUser *user, SircMessageContext *context, const char *fmt, ...);
void srn_chat_add_error_message(SrnChat *self, const char *content, SircMessageContext *context);
void srn_chat_add_error_message_fmt(SrnChat *self, SircMessageContext *context, const char *fmt, ...);
void srn_chat_add_error_message_with_user(SrnChat *chat, SrnChatUser *user, const char *content, SircMessageContext *context);
void srn_chat_add_error_message_with_user_fmt(SrnChat *chat, SrnChatUser *user, SircMessageContext *context, const char *fmt, ...);
void srn_chat_set_topic(SrnChat *chat, SrnChatUser *user, const char *topic, SircMessageContext *context);
