...
void ui_window_init(){
    ...
    UI_BUILDER_GET_WIDGET(builder, chan_panel_stack);
    ...
    /* transition effect */
    gtk_stack_set_transition_type(GTK_STACK(chan_panel_stack), GTK_STACK_TRANSITION_TYPE_SLIDE_UP_DOWN);
