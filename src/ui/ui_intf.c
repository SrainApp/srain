...
void ui_intf_sys_msg (IRCServer *server, const char *target,
...
void ui_intf_recv_msg(IRCServer *server, const char *target,
        const char *nick, const char *id, const char *msg){
}

void ui_intf_user_join(IRCServer *server, const char *chan_name,
        const char *nick, IRCUserType type, int notify){
}

void ui_intf_user_part(IRCServer *server, const char *chan_name,
